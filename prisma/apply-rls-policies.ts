 ...
 * 
 * This script reads the rls_policies.sql file and executes it using Prisma
 * to enable tenant isolation in the database.
 * 
 * Run with: npx ts-node prisma/apply-rls-policies.ts
 */
...
async function main() {
    ...
    try {
        ...
        for (let i = 0; i < statements.length; i++) {
            ...
            try {
                // Get a preview of the statement (first line)
