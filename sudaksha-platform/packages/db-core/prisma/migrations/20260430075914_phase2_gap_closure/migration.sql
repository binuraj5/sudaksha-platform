...
-- CreateEnum
CREATE TYPE "ModelSourceType" AS ENUM ('ROLE_BASED', 'COMPETENCY_BASED', 'CUSTOM', 'TEMPLATE', 'SCIP', 'ADAPT_16');
...
CREATE TABLE "AssessmentModel" (
    ...
    "minRetakeIntervalDays" INTEGER NOT NULL DEFAULT 90,
    "requiresBrowserLockdown" BOOLEAN NOT NULL DEFAULT false,
    "lockdownConfig" JSONB NOT NULL DEFAULT '{}',
...
CREATE TABLE "Activity" (
    ...
    "completionCriteria" TEXT NOT NULL DEFAULT 'TIME_SPENT',
...
CREATE TABLE "MicroAssessment" (
    ...
    CONSTRAINT "MicroAssessment_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "SCIPDimensionScore" (
    "id" TEXT NOT NULL,
    "memberAssessmentId" TEXT NOT NULL,
    ...
    CONSTRAINT "SCIPDimensionScore_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BiasFlag" (
    ...
    "w1CorrectionFactor" DOUBLE PRECISION,
...
-- CreateTable
CREATE TABLE "NormativeProfile" (
    "id" TEXT NOT NULL,
    "competencyCode" TEXT NOT NULL,
    "cohortType" TEXT NOT NULL,
    "assessmentType" TEXT NOT NULL DEFAULT 'ADAPT_16',
    "sampleSize" INTEGER NOT NULL DEFAULT 0,
    "meanScore" DOUBLE PRECISION NOT NULL DEFAULT 50.0,
    "stdDeviation" DOUBLE PRECISION NOT NULL DEFAULT 15.0,
    "p30Threshold" DOUBLE PRECISION NOT NULL DEFAULT 40.0,
    "p60Threshold" DOUBLE PRECISION NOT NULL DEFAULT 55.0,
    "p85Threshold" DOUBLE PRECISION NOT NULL DEFAULT 72.0,
    "lastUpdated" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "isCalibrated" BOOLEAN NOT NULL DEFAULT false,

    CONSTRAINT "NormativeProfile_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ComponentQuestion_targetCohort_idx" ON "ComponentQuestion"("targetCohort");

-- CreateIndex
CREATE INDEX "ComponentQuestion_itemPoolTag_idx" ON "ComponentQuestion"("itemPoolTag");
...
-- CreateIndex
CREATE INDEX "ActivityMember_status_idx" ON "ActivityMember"("status");
...
-- CreateIndex
CREATE INDEX "CompetencyScore_memberAssessmentId_idx" ON "CompetencyScore"("memberAssessmentId");

-- CreateIndex
CREATE INDEX "CompetencyScore_competencyCode_idx" ON "CompetencyScore"("competencyCode");

-- CreateIndex
CREATE INDEX "CompetencyScore_assessmentType_idx" ON "CompetencyScore"("assessmentType");

-- CreateIndex
CREATE UNIQUE INDEX "CompetencyScore_memberAssessmentId_competencyCode_assessmen_key" ON "CompetencyScore"("memberAssessmentId", "competencyCode", "assessmentType");

-- CreateIndex
CREATE INDEX "AssessmentDelta_memberId_idx" ON "AssessmentDelta"("memberId");

-- CreateIndex
CREATE INDEX "AssessmentDelta_baselineAssessmentId_idx" ON "AssessmentDelta"("baselineAssessmentId");

-- CreateIndex
CREATE INDEX "CareerFitScore_memberId_idx" ON "CareerFitScore"("memberId");

-- CreateIndex
CREATE INDEX "CareerFitScore_fitScore_idx" ON "CareerFitScore"("fitScore");

-- CreateIndex
CREATE UNIQUE INDEX "CareerFitScore_memberId_roleId_memberAssessmentId_key" ON "CareerFitScore"("memberId", "roleId", "memberAssessmentId");

-- CreateIndex
CREATE INDEX "MicroAssessment_memberId_idx" ON "MicroAssessment"("memberId");

-- CreateIndex
CREATE INDEX "MicroAssessment_activityId_idx" ON "MicroAssessment"("activityId");

-- CreateIndex
CREATE INDEX "MicroAssessment_competencyCode_idx" ON "MicroAssessment"("competencyCode");

-- CreateIndex
CREATE INDEX "MicroAssessment_completedAt_idx" ON "MicroAssessment"("completedAt");

-- CreateIndex
CREATE INDEX "SCIPDimensionScore_memberAssessmentId_idx" ON "SCIPDimensionScore"("memberAssessmentId");

-- CreateIndex
CREATE UNIQUE INDEX "SCIPDimensionScore_memberAssessmentId_dimension_key" ON "SCIPDimensionScore"("memberAssessmentId", "dimension");

-- CreateIndex
CREATE INDEX "BiasFlag_memberAssessmentId_idx" ON "BiasFlag"("memberAssessmentId");

-- CreateIndex
CREATE INDEX "BiasFlag_flagType_idx" ON "BiasFlag"("flagType");

-- CreateIndex
CREATE INDEX "NormativeProfile_competencyCode_idx" ON "NormativeProfile"("competencyCode");

-- CreateIndex
CREATE INDEX "NormativeProfile_cohortType_idx" ON "NormativeProfile"("cohortType");

-- CreateIndex
CREATE UNIQUE INDEX "NormativeProfile_competencyCode_cohortType_assessmentType_key" ON "NormativeProfile"("competencyCode", "cohortType", "assessmentType");
...
-- AddForeignKey
ALTER TABLE "CompetencyScore" ADD CONSTRAINT "CompetencyScore_memberAssessmentId_fkey" FOREIGN KEY ("memberAssessmentId") REFERENCES "MemberAssessment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AssessmentDelta" ADD CONSTRAINT "AssessmentDelta_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AssessmentDelta" ADD CONSTRAINT "AssessmentDelta_baselineAssessmentId_fkey" FOREIGN KEY ("baselineAssessmentId") REFERENCES "MemberAssessment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AssessmentDelta" ADD CONSTRAINT "AssessmentDelta_followupAssessmentId_fkey" FOREIGN KEY ("followupAssessmentId") REFERENCES "MemberAssessment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CareerFitScore" ADD CONSTRAINT "CareerFitScore_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CareerFitScore" ADD CONSTRAINT "CareerFitScore_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CareerFitScore" ADD CONSTRAINT "CareerFitScore_memberAssessmentId_fkey" FOREIGN KEY ("memberAssessmentId") REFERENCES "MemberAssessment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MicroAssessment" ADD CONSTRAINT "MicroAssessment_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MicroAssessment" ADD CONSTRAINT "MicroAssessment_activityId_fkey" FOREIGN KEY ("activityId") REFERENCES "Activity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SCIPDimensionScore" ADD CONSTRAINT "SCIPDimensionScore_memberAssessmentId_fkey" FOREIGN KEY ("memberAssessmentId") REFERENCES "MemberAssessment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BiasFlag" ADD CONSTRAINT "BiasFlag_memberAssessmentId_fkey" FOREIGN KEY ("memberAssessmentId") REFERENCES "MemberAssessment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
