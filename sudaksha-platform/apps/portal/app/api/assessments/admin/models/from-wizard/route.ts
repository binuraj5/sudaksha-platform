...
export async function POST(request: Request) {
    try {
        ...
        let { roleId, targetLevel, name, components, competencyWeights, requesterId, requestId, tenantId: bodyTenantId } = body;
        ...
        let tenantId = bodyTenantId ?? userContext.tenantId ?? null;
