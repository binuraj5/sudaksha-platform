...
export default function OrgModelDetailsPage({
    ...
    params: Promise<{ slug: string; modelId: string }>;
}) {
    ...
    const baseUrl = `/assessments/org/${slug}/models`;
    const builderBaseUrl = `/assessments/org/${slug}/assessments`;
        ...
        return (
            <div className="container mx-auto py-16 px-4 text-center">
                ...
                <Button asChild variant="outline">
                    <Link href={baseUrl}>Back to Models</Link>
                </Button>
            </div>
        );
    }
            ...
            <div className="flex flex-col gap-4 mb-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <Link href={`${builderBaseUrl}/${modelId}/builder`}>
                            <Button className="gap-2 bg-navy-700 hover:bg-navy-600">
                                <Layout className="w-4 h-4" />
                                Open Builder
                            </Button>
                        </Link>
                        <Link href={`${builderBaseUrl}/${modelId}/questions`}>
                    ...
                    {components.length === 0 ? (
                        <div className="py-12 px-6 text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-4">
                                No components yet. Add them in the Builder.
                            </p>
                            <Link href={`${baseUrl}/${modelId}/builder`}>
                        ...
                        <div className="divide-y">
                            {components.map((comp) => (
                                <Link
                                    key={comp.id}
                                    href={`${baseUrl}/${modelId}/questions`}
