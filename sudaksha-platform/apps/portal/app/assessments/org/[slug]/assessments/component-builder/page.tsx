...
export default async function OrgComponentBuilderPage({
    params,
}: {
    ...
    return <ComponentLibraryBrowser basePath={`/assessments/org/${slug}/assessments/create`} clientId={tenant.id} />;
}
