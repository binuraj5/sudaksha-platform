...
export default async function OrgNewEmployeePage({
    params,
}: {
    ...
    return (
        <div className="p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-500 mb-6">
                Invite a new {labels.member.toLowerCase()} to the organization.
            </p>
            <CreateEmployeeDialog clientId={tenant.id} defaultOpen redirectBase={basePath} />
        </div>
    );
}
