        ...
        (async () => {
            try {
                ...
                if (data.type !== "INSTITUTION") {
                    setError("Not an institution tenant");
                    return;
                }
                setTenant(data);
            } catch {
    ...
    if (error || !tenant) {
        return (
            <div className="space-y-4">
                <Link
                    href="/assessments/admin/institutions"
                ...
                <Card className="border-destructive/50">
                    <CardContent className="pt-6">
                        <p className="text-sm text-destructive">{error || "Institution not found"}</p>
                    </CardContent>
                </Card>
            </div>
        );
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">/{tenant.slug} · Institution</p>
                        </div>
                    </div>
                </div>
