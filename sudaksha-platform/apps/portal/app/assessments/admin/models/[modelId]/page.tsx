...
export default function ModelDetailsPage({ params }: { params: Promise<{ modelId: string }> }) {
            ...
            <div className="flex flex-col gap-4 mb-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Link href={`/assessments/admin/models/${modelId}/questions`}>
                    ...
                    {components.length === 0 ? (
                        ...
                        <div className="divide-y">
                            {components.map((comp) => (
                                <Link
                                    key={comp.id}
                                    href={`/assessments/admin/models/${modelId}/questions`}
