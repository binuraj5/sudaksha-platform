...
import { Users, Award, Clock, Target, Handshake, Building } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Training Programs: Building Digital Excellence
          </h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-12">
            Flexible training programs designed to meet diverse learning needs and career goals across Africa, MENA, and emerging markets
          </p>
        </div>
