...
export function AdaptiveRunner({
    ...
    // Local retry key — incrementing re-fires the startup useEffect without reloading the page
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                // competencyId and targetLevel are optional — the API looks them up from the DB
    ...
    }, [assessmentId, componentId, competencyId, targetLevel, retryKey]);
        ...
        return (
            <Card>
                <CardContent className="pt-6 space-y-4">
                    <p className="text-red-600 font-medium">⚠ Could not start adaptive section</p>
