    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <Textarea
                    id="description"
                    placeholder="Provide a general overview of this role..."
                    className="h-32"
            ...
            <div className="space-y-2">
                <Label htmlFor="keyResponsibilities">Key Responsibilities (Org-Assigned)</Label>
                <Textarea
                    id="keyResponsibilities"
                    placeholder="List the specific organizational responsibilities for this role..."
                    className="h-32"
