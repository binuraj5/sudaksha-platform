...
export function ModelsPageContent({ isAdmin, clientId, baseUrl: baseUrlProp }: ModelsPageContentProps) {
    ...
    const isOrg = baseUrl.includes('/org/');
    const builderBaseUrl = isOrg ? baseUrl.replace('/models', '/assessments') : baseUrl;
        ...
        <div className="container mx-auto py-8 px-4 max-w-7xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                {permissions.canCreate && (
                    <Link href={`${builderBaseUrl}/create`}>
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end" className="w-48 shadow-xl border-gray-100 ring-1 ring-black/5">
                                                        ...
                                                        {(model._canEdit || model.status === 'DRAFT') && permissions.canCreate && (
                                                            <DropdownMenuItem
                                                                className="gap-2 cursor-pointer font-medium py-2 text-sm"
                                                                onClick={() => router.push(`${builderBaseUrl}/${model.id}/builder`)}
                                                            >
                                                        ...
                                                        <DropdownMenuItem
                                                            className="gap-2 cursor-pointer font-medium py-2 text-sm"
                                                            onClick={() => router.push(`${builderBaseUrl}/${model.id}/questions`)}
                                                        >
