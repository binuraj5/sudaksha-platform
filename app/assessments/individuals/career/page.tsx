    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-8">
            ...
            <Tabs defaultValue="overview" className="w-full">
                ...
                {/* MY PROFILE – CareerProfileForm: Personal & Bio, Education, Work Experience, Technical Skills, Certifications, Projects, Awards & Languages, Career Goals, Role Selection */}
                ...
                {/* HIERARCHY – placeholder, same card style */}
