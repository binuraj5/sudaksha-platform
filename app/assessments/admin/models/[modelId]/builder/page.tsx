...
function AssessmentBuilder({ modelId, backHref = "/assessments/admin/models", completeHref }: AssessmentBuilderProps) {
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            setCompetencies(uniqueCompetencies as Competency[]);
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {(() => {
                                            ...
                                            const suggestions = comp
                                                ? ComponentSuggester.suggestComponents(comp as unknown as { category: "TECHNICAL" | "BEHAVIORAL" | "COGNITIVE" | "DOMAIN_SPECIFIC" }, targetLevel as "JUNIOR" | "MIDDLE" | "SENIOR" | "EXPERT")
                                                : [];
