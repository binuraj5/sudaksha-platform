...
export default function OnboardingWizard() {
    ...
    const handleNext = () => {
        ...
        if (step === 2) {
            // Auto-select competencies from aspirational role that are NOT in current role
            // Simplified: Just selecting interesting ones.
            // For now, let's just pre-select all from aspirational role to be helpful
                ...
                <div className="mb-8">
                    ...
                    <div className="h-2 bg-gray-200 rounded-full">
                        <motion.div
                            ...
                            initial={{ width: "0%" }}
                            animate={{ width: `${((step - 1) / 2) * 100}%` }} // Simplified visual progress
                        />
                    </div>
                </div>
                                ...
                                {step === 3 && (
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            ...
                                            {/* Could add other competencies here */}
                                        </div>
                                    </div>
                                )}
                            </CardContent>
